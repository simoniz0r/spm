...
sed -i 's%    url: https://github.com/ozmartian/releases%    url: https://github.com/ozmartian/vidcutter/releases%g;s%    apiurl: https://api.github.com/repos/ozmartian/releases%    apiurl: https://api.github.com/ozmartian/vidcutter/releases%g' /home/$USER/github/spm/AppImages-github.yaml # Fix broken link
